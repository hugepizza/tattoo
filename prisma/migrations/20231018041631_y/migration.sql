...
-- CreateIndex
CREATE UNIQUE INDEX "Draft_proxyId_key" ON "Draft"("proxyId");

-- CreateIndex
CREATE UNIQUE INDEX "Tattoo_proxyId_key" ON "Tattoo"("proxyId");
...
-- AddForeignKey
ALTER TABLE "Tattoo" ADD CONSTRAINT "Tattoo_draftId_fkey" FOREIGN KEY ("draftId") REFERENCES "Draft"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
